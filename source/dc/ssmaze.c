...
typedef struct _Wall
{
    FxPt2 f, t;
    int col;
    Texture *pTex;  // points to texture
} Wall;
...
/*
void (FGAPIENTRY *convex_solids[SPECIAL_ARG_COUNT])(void) =
{
...
#define AA_LINES 1
    ...
    //glCallList( (int)maze_walls_list );
